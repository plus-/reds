...
/**
  * Demultiplicate indexed words with every matching begining.
  *
  * @param {Array} words
  ...
  * @api private
  */
exports.fuzzyWords = function(words, precision) {
  fuzzyWords = [];
  words.forEach(function(word) {
    var i = 0;
    while (i < word.length) {
      i = i + precision;
      fuzzyWords.push(word.substr(0,i));
    }
  });
  return fuzzyWords;
};
...
Search.prototype.index = function(str, id, fn){
  ...
  if (this.precision) {
    words = exports.fuzzyWords(words, this.precision);
  }
...
Search.prototype.fuzzy= function(precision){
